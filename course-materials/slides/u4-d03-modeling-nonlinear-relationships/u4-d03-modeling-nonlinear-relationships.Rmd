...
## Transform (and roll out), or do more thinking?

- Data transformations may also be useful when the relationship is non-linear
- However in those cases a polynomial regression or smoother may be more appropriate
- Lean toward using an appropriate probability model for your data rather than transformations to meet linear modeling assumptions
- Complex transformations may give regression coefficients that are easy to interpret!
